...
export default function Achievements() {
  ...
  const { level, xp, levelName, loading, achievements } = useGamification();
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col gap-6 md:gap-8">
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20 gap-4">
              ...
              <p className="text-slate-400 text-sm font-semibold">Analyzing your achievements...</p>
            </div>
          ) : (
            <>
              ...
              >
                <Card className="glass-card neon-border border-0 bg-slate-900/60 backdrop-blur-xl p-8 relative overflow-hidden">
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                    {/* Level avatar */}
                    <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-amber-400 to-pink-600 flex items-center justify-center text-white text-4xl font-black shadow-lg shadow-amber-500/20 animate-pulse">
                      {level}
                    </div>
                    
                    <div className="flex-1 w-full">
                      <span className="text-[10px] font-bold text-amber-400 uppercase tracking-widest block">Current System Rank</span>
                      <h2 className="text-white text-2xl font-black mt-1">{levelName}</h2>
