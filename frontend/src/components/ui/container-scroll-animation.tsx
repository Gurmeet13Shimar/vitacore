...
export const ContainerScroll = ({
  ...
  if (!scrollContainer) {
    return <div className="h-[45rem] md:h-[58rem]" />;
  }
...
const ContainerScrollInner = ({
  ...
  return (
    <div
      className="h-[45rem] md:h-[58rem] flex items-center justify-center relative p-2 md:p-10"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    ...
    >
      <div className=" h-full w-full  overflow-hidden rounded-2xl bg-[#07071A] md:rounded-2xl md:p-4 ">
        {children}
      </div>
    </motion.div>
  );
